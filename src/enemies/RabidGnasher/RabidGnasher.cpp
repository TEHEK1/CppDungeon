...
enemies::RabidGnasher::RabidGnasher::RabidGnasher():
    entity::Enemy("RabidGnasher",
    ...
    {static_cast<int>(Characteristic::speed), 8},
    ...
    {std::make_shared<RabidRush>()}){}


std::vector<std::vector<char>> enemies::RabidGnasher::RabidGnasher::drawAlive(){
    return {
        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
