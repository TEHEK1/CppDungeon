...
namespace items {
    namespace Absinthe{
        AbsintheEffect::AbsintheEffect() : skillDesigns::RangeSkill(0, "Absinthe Effect", {1, 2, 3, 4},
                                                                                    {1, 2, 3, 4}, {}, 100) {}

        void AbsintheEffect::unsafeTargetUse(int crited, std::shared_ptr<BattleField> battleField,
                                                     std::shared_ptr<entity::Entity> actor,
                                                     std::shared_ptr<entity::Entity> object) {}

        void AbsintheEffect::unsafeSelfUse(int crited, std::shared_ptr<BattleField> battleField,
                                                   std::shared_ptr<entity::Entity> object) {
