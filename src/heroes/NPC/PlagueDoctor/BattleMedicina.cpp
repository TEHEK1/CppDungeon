...
namespace NPC {
    namespace PlagueDoctor {
        BattleMedicine::BattleMedicine():Skill("BattleMedicine", {1, 2, 3}, {1, 2, 3}, {}, 100, 0);

        unsafeTargetUse(int crited, std::shared_ptr<BattleField> battleField,
            ...
            (crited, 2,std::map<int, int> {{static_cast<int> (Characteristic::speed), 3}, {static_cast<int> (Characteristic::minDamage), 20}, {static_cast<int> (Characteristic::maxDamage), 20}}), battleField, crited, 100);
        }

        unsafeSelfUse(int crited, std::shared_ptr<BattleField> battleField,
